      ...
      >
        {items.concat(items).map((it, i) => (
          ...
          >
            ...
            <div className="font-semibold mr-1 font-rajdhani">{it.symbol}</div>

            <div className="text-[(--fluxa-muted)] font-rajdhani font-bold">
              {it.price === undefined ? (
            ...
            <div
              className={`ml-2 text-xs font-semibold font-rajdhani`}
              style={{
                color:
                  it.change == null
                    ? undefined
